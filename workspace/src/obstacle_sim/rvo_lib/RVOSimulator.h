...
namespace RVO {
	...
	public:
		...
		size_t addAgent(std::string name, 
		...
		const Vector2 &getAgentPosition(std::string name) const;
		...
		float getAgentRadius(std::string name) const;
		...
		void setAgentPrefVelocity(std::string name, const Vector2 &prefVelocity);
